...
const client = require('twilio')(config.tokenGenerator.accountSid, config.tokenGenerator.authToken);

client.chat.services(config.tokenGenerator.serviceSid)
    .update({
    ...
    .then(service => console.log(service.notifications.new_message));
